...
// ImageProc_20211546View.h: CImageProc20211546View 클래스의 인터페이스
//

#pragma once


class CImageProc20211546View : public CScrollView
{
protected: // serialization에서만 만들어집니다.
	CImageProc20211546View() noexcept;
	DECLARE_DYNCREATE(CImageProc20211546View)
...
// 구현입니다.
public:
	virtual ~CImageProc20211546View();
#ifdef _DEBUG
...
public:
	...
	afx_msg void OnPixelContrastStreching();
	...
	void Convole(unsigned char** Inimg, unsigned char** Outimg, int cols, int rows, float mask[][3], int bias, int depth);
...
inline CImageProc20211546Doc* CImageProc20211546View::GetDocument() const
   { return reinterpret_cast<CImageProc20211546Doc*>(m_pDocument); }
#endif
